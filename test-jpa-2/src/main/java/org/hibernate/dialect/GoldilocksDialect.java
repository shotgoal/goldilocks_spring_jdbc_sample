...
class GoldilocksIdentityColumnSupport extends IdentityColumnSupportImpl {
	...
	public String getIdentitySelectString(String table, String column, int type) throws MappingException {
		return "select last_identity_value() from dual";
	}
...
public class GoldilocksDialect extends Dialect {
	...
	public IdentityColumnSupport getIdentityColumnSupport(){
		return new GoldilocksIdentityColumnSupport();
	}
	...
	public String getQueryHintString(String query, String hints){
		if( hints != null && hints.isEmpty() ){
			...
			if ( pos > -1 ) {
				...
				buffer.append( "select /*+ " ).append( hints ).append( " */" ).append( query.substring( pos + "select".length() ) );
				query = buffer.toString();
			}
		}
		return query;
